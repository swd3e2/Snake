...
public:
	void init(entt::registry* registry) {
        ...
        const char* vertexShaderCode = "\
            ...
            \n\
            void main() {\n\
                gl_Position = vec4(pos.x, pos.y, pos.z, 1.0f) * WVP;\n\
        ...
        const char* pixelShaderCode = "\
            ...
            void main()\n\
            {\n\
                FragColor = texture(diffuseTexture, fs_in.texCoord);\n\
            }\n\
        ";
	...
	void update(double dt) {
		...
		projectionData.projection = glm::transpose(glm::perspective(glm::radians(80.0f), 16.0f / 9.0f, 0.2f, 100.f) 
            * glm::translate<float>(glm::mat4(1.0f), glm::vec3(cameraX, cameraY, -25.0f)));
